...
const EarthViewer = React.forwardRef(({ objects, onObjectClick, tcaMarker, avoidancePath }, ref) => {
  ...
  const movePanel = useCallback((event) => {
    ...
    const panelElement = event.currentTarget.closest('.selector-panel');
  ...
  const moveConjunctionPanel = useCallback((event) => {
    ...
    const panelElement = event.currentTarget.closest('.conjunction-panel');
    const handleMove = (moveEvent) => {
      const width = 680;
      const height = 190;
      const currentPanelHeight = panelElement?.getBoundingClientRect().height ?? height;
  ...
  const moveLegendPanel = useCallback((event) => {
    ...
    const panelElement = event.currentTarget.closest('.legend-panel');
    const handleMove = (moveEvent) => {
      const width = 240;
      const height = 260;
      const currentPanelHeight = panelElement?.getBoundingClientRect().height ?? height;
